...
static QMap<QString, QMap<QString, QString>> translations = []() {
    ...
    t["en"]["ok"] = "OK";
    t["en"]["enter_domain"] = "Enter domain to search";
    t["en"]["enter_geosite_tag"] = "Enter geosite:tag";
    t["en"]["enter_geoip_tag"] = "Enter geoip:tag";
    t["en"]["no_results_to_copy"] = "No results to copy";
    t["en"]["no_results_to_save"] = "No results to save";
    t["en"]["copied"] = "Result copied to clipboard";
    t["en"]["saved_to"] = "Saved: %1";
    t["en"]["set_geosite_path"] = "Set path to geosite.dat";
    t["en"]["set_geoip_path"] = "Set path to geoip.dat";
    t["en"]["file_not_found"] = "File not found: %1";
    t["en"]["loading_geosite"] = "Loading geosite.dat...";
    t["en"]["loading_geoip"] = "Loading geoip.dat...";
    t["en"]["load_geosite_failed"] = "Failed to load geosite: %1";
    t["en"]["load_geoip_failed"] = "Failed to load geoip: %1";
    t["en"]["ready"] = "Ready";
    t["en"]["searching_categories"] = "Searching domain categories...";
    t["en"]["not_found"] = "Not found";
    t["en"]["categories_found"] = "Categories found: %1";
    t["en"]["getting_domains"] = "Getting domains from geosite...";
    t["en"]["and_more"] = "... and %1 more";
    t["en"]["domains_count"] = "Domains (%1):";
    t["en"]["empty_list"] = "List is empty";
    t["en"]["domains_received"] = "Domains received: %1";
    t["en"]["dns_progress"] = "DNS resolving: %1/%2";
    ...
    t["en"]["ip_cidr_count"] = "IP/CIDR (%1):";
    t["en"]["ranges_received"] = "Ranges received: %1";
    t["en"]["info"] = "Info";
